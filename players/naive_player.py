    ...
    def SelectMove(self, moves, game_state):
        ...
        for mid,fid,tgrab in moves:
            if most_to_line == -1:
                ...
                most_to_line = tgrab.num_to_pattern_line #num_to_pattern tells minimum slots available that can be placed on your board line
                corr_to_floor = tgrab.num_to_floor_line #how many will get thrown to floor
                continue
